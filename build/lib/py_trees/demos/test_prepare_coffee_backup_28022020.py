...
def create_behavior_tree(json_schema):
    ...
    initialise_prepostcondition_lists_root = py_trees.composites.Sequence("Initialise Pre and Postconditions in Blackboard")
    ...
    set_emphasized_object = py_trees.behaviours.SetEmphasis()
    # Add Set Emphasis Subtree
    set_emphasis_root = py_trees.composites.Sequence("Attentional Subtree")
    set_emphasis_root.add_children([
        initialise_prepostcondition_lists_root,
        set_emphasized_object])

    check_emphasis_root_sequence = py_trees.composites.Sequence("Emphasis Subtree")
    updated_emphasis_root_selector = py_trees.composites.Selector("Retrieve & Expand Emphasized Subtree")
    updated_emphasis_selector = py_trees.behaviours.CheckBlackboardVariableValue(name="Changed Emphasis?",
    ...
    updated_emphasis_root_selector.add_children([
        updated_emphasis_selector,
        prepare_coffee_root
        # Note: Postcondition list is updated inside emphasized_tree idiom
    ])
    check_emphasis_root_sequence.add_child(
        updated_emphasis_root_selector
        # create new tree
    )
