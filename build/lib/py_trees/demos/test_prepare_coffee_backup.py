...
def create_behavior_tree(json_schema):
    ...
    root = py_trees.composites.Sequence("Prepare Coffee")
    ...
    ###########################
    retrieve_and_expand_root_parallel = py_trees.composites.Parallel("Retrieve & Expand Tree")
    ...
    #end = py_trees.composites.behaviour.logging("End of Task")
    #end = py_trees.composites.behaviour.Behaviour.feedback_message("End")
    root.add_children([
